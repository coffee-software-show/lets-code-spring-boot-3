...
export declare const keyDocument: (node: string | DocumentNode) => KeyedDocumentNode;
export declare const createRequest: <Data = any, Variables extends AnyVariables = AnyVariables>(q: string | DocumentNode | TypedDocumentNode<Data, Variables>, variables: Variables) => GraphQLRequest<Data, Variables>;
/**

...
echo "create table if not exists customers(id serial primary key, name text  not null ,subscribed bool default false not null);" | PGPASSWORD=postgres psql -U postgres -h localhost postgres
